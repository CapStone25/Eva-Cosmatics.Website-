...
const staticProducts = [
  ...
  },
  {
    ...
    price: 50,
    description: "A deeply hydrating cream with snail mucin for smooth, supple skin. This luxurious formula penetrates deep into the skin layers to provide long-lasting moisture.",
    image: productRecipe,
    category: "Moisturizer",
    skin_type: "Combination/Oily",
    ingredients: ["Snail Mucin: regenerating", "Hyaluronic Acid: hydrating", "Adenosine: anti-aging"],
  },
  {
    id: "static-3",
    name: "Clarifying Emulsion",
    price: 50,
    description: "A lightweight emulsion that clarifies and balances skin. Perfect for sensitive skin types looking for gentle yet effective care.",
    image: productConditioner,
    category: "Emulsion",
    skin_type: "Sensitive",
    ingredients: ["Centella Asiatica: soothing", "Tea Tree: purifying", "Aloe Vera: calming"],
  },
  {
    id: "static-4",
  ...
  },
  {
    ...
    price: 50,
    description: "A premium bio cellulose mask infused with fermented soybean extract for deep nourishment and skin renewal.",
    image: product2,
    category: "Mask",
    skin_type: "Normal",
    ingredients: ["Fermented Soybean: nourishing", "Bio Cellulose: hydrating", "Peptides: firming"],
  },
  {
    id: "static-6",
    name: "Pore Clearing Clay Mask 2X",
    price: 50,
    description: "A powerful clay mask that deeply cleanses pores and removes impurities for clearer, smoother skin.",
    image: product3,
    category: "Mask",
    skin_type: "All",
    ingredients: ["Kaolin Clay: cleansing", "Charcoal: purifying", "Green Tea: antioxidant"],
  },
  {
    id: "static-7",
    name: "Matte Priming UV Shield Sunscreen SPF 37",
    price: 50,
    description: "A matte-finish sunscreen that primes skin for makeup while providing excellent UV protection.",
    image: productLotion,
    category: "Sunscreen",
    skin_type: "Dry",
    ingredients: ["Zinc Oxide: UV protection", "Silica: mattifying", "Vitamin E: nourishing"],
  },
  {
    id: "static-8",
    name: "Soft Finish Sun Milk SPF50+/PA+++",
    price: 50,
    description: "A lightweight sun milk with the highest UV protection that leaves skin soft and smooth.",
    image: product4,
    category: "Sunscreen",
    skin_type: "Dry",
    ingredients: ["Titanium Dioxide: UV protection", "Hyaluronic Acid: hydrating", "Squalane: moisturizing"],
  },
  {
    id: "static-9",
    name: "Skin Reinforcement Get Type Cream",
    price: 50,
    description: "A reinforcing cream that strengthens skin barrier and improves skin resilience.",
    image: productSerum,
    category: "Cream",
    skin_type: "Normal",
    ingredients: ["Ceramides: barrier strengthening", "Peptides: firming", "Niacinamide: brightening"],
  },
  {
    id: "static-10",
    name: "Lychee Soda Bubble Cleanser",
    price: 50,
    description: "A fun, fizzy bubble cleanser with lychee extract that gently removes makeup and impurities.",
    image: product1,
    category: "Cleanser",
    skin_type: "All",
    ingredients: ["Lychee Extract: antioxidant", "Citric Acid: gentle exfoliation", "Glycerin: hydrating"],
  },
  {
    id: "static-11",
    name: "Rice Sheet Mask",
    price: 50,
    description: "A nourishing sheet mask infused with rice extract for brighter, more luminous skin.",
    image: product2,
    category: "Mask",
    skin_type: "Sensitive",
    ingredients: ["Rice Extract: brightening", "Rice Bran Oil: nourishing", "Vitamin B: soothing"],
  },
  {
    id: "static-12",
    name: "Gentle Exfoliating Toner",
    price: 50,
    description: "A gentle toner with mild exfoliating properties that refines skin texture.",
    image: productConditioner,
    category: "Toner",
    skin_type: "Combination/Oily",
    ingredients: ["BHA: gentle exfoliation", "Willow Bark: pore care", "Witch Hazel: toning"],
  },
];
